...
class MiddlewareDispatcher implements MiddlewareDispatcherInterface
{
     ...
     *
     * Middlewares are organized as a stack. That means middleware
        ...
        $this->tip = new class (
            ...
            public function handle(ServerRequestInterface $request): ResponseInterface
            {
                ...
                if (!$callable) {
                    ...
                    if ($this->container && $this->container->has($resolved)) {
                        ...
                        if (!class_exists($resolved)) {
                            throw new RuntimeException(sprintf('Middlewares %s does not exist', $resolved));
                        }
                ...
                if (!is_callable($callable)) {
                    throw new RuntimeException(
                        sprintf(
                            'Middlewares %s is not resolvable',
                            $this->middleware
                        )
                    );
                }
